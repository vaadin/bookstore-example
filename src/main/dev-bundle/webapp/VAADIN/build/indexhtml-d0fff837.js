...
This is probably caused by illegal octal escape sequences.`),{_$litType$:i,strings:e,values:t}),E=fi(Rn),ho=fi(xe),B=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),zt=new WeakMap,q=Y.createTreeWalker(Y,129,null,!1);let z=Ne;const In=(i,e)=>{const t=i.length-1,n=[];let o=e===xe?"<svg>":"",r,s=ee;for(let a=0;a<t;a++){const d=i[a];let c=-1,u,h=0,p;for(;h<d.length&&(s.lastIndex=h,p=s.exec(d),p!==null);)if(h=s.lastIndex,s===ee){if(p[Vt]==="!--")s=Mt;else if(p[Vt]!==void 0)s=Ut;else if(p[je]!==void 0)pi.test(p[je])&&(r=new RegExp(`</${p[je]}`,"g")),s=U;else if(p[Tn]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else s===U?p[$n]===">"?(s=r??ee,c=-1):p[Ft]===void 0?c=-2:(c=s.lastIndex-p[xn].length,u=p[Ft],s=p[Bt]===void 0?U:p[Bt]==='"'?qe:Ge):s===qe||s===Ge?s=U:s===Mt||s===Ut?s=ee:(s=U,r=void 0);console.assert(c===-1||s===U||s===Ge||s===qe,"unexpected parse state B");const W=s===U&&i[a+1].startsWith("/>")?" ":"";o+=s===ee?d+wn:c>=0?(n.push(u),d.slice(0,c)+st+d.slice(c)+P+W):d+P+(c===-2?(n.push(void 0),a):W)}const l=o+(i[t]||"<?>")+(e===xe?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(a)}return[Dt!==void 0?Dt.createHTML(l):l,n]};class ae{constructor({strings:e,["_$litType$"]:t},n){this.parts=[];let o,r=0,s=0;const l=e.length-1,a=this.parts,[d,c]=In(e,t);if(this.el=ae.createElement(d,n),q.currentNode=this.el.content,t===xe){const u=this.el.content,h=u.firstChild;h.remove(),u.append(...h.childNodes)}for(;(o=q.nextNode())!==null&&a.length<l;){if(o.nodeType===1){{const u=o.localName;if(/^(?:textarea|template)$/i.test(u)&&o.innerHTML.includes(P)){const h=`Expressions are not supported inside \`${u}\` elements. See https://lit.dev/msg/expression-in-${u} for more information.`;if(u==="template")throw new Error(h);$e("",h)}}if(o.hasAttributes()){const u=[];for(const h of o.getAttributeNames())if(h.endsWith(st)||h.startsWith(P)){const p=c[s++];if(u.push(h),p!==void 0){const Ae=o.getAttribute(p.toLowerCase()+st).split(P),j=/([.?@])?(.*)/.exec(p);a.push({type:ct,index:r,name:j[2],strings:Ae,ctor:j[1]==="."?Pn:j[1]==="?"?Vn:j[1]==="@"?Mn:ke})}else a.push({type:ht,index:r})}for(const h of u)o.removeAttribute(h)}if(pi.test(o.tagName)){const u=o.textContent.split(P),h=u.length-1;if(h>0){o.textContent=K?K.emptyScript:"";for(let p=0;p<h;p++)o.append(u[p],re()),q.nextNode(),a.push({type:Re,index:++r});o.append(u[h],re())}}}else if(o.nodeType===8)if(o.data===hi)a.push({type:Re,index:r});else{let h=-1;for(;(h=o.data.indexOf(P,h+1))!==-1;)a.push({type:Ln,index:r}),h+=P.length-1}r++}f==null||f({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,t){const n=Y.createElement("template");return n.innerHTML=e,n}}function J(i,e,t=i,n){var o,r,s,l;if(e===B)return e;let a=n!==void 0?(o=t.__directives)===null||o===void 0?void 0:o[n]:t.__directive;const d=se(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==d&&((r=a==null?void 0:a._$notifyDirectiveConnectionChanged)===null||r===void 0||r.call(a,!1),d===void 0?a=void 0:(a=new d(i),a._$initialize(i,t,n)),n!==void 0?((s=(l=t).__directives)!==null&&s!==void 0?s:l.__directives=[])[n]=a:t.__directive=a),a!==void 0&&(e=J(i,a._$resolve(i,e.values),a,n)),e}class On{constructor(e,t){this._parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=t}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){var t;const{el:{content:n},parts:o}=this._$template,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Y).importNode(n,!0);q.currentNode=r;let s=q.nextNode(),l=0,a=0,d=o[0];for(;d!==void 0;){if(l===d.index){let c;d.type===Re?c=new ce(s,s.nextSibling,this,e):d.type===ct?c=new d.ctor(s,d.name,d.strings,this,e):d.type===ht&&(c=new Un(s,this,e)),this._parts.push(c),d=o[++a]}l!==(d==null?void 0:d.index)&&(s=q.nextNode(),l++)}return r}_update(e){let t=0;for(const n of this._parts)n!==void 0&&(f==null||f({kind:"set part",part:n,value:e[t],valueIndex:t,values:e,templateInstance:this}),n.strings!==void 0?(n._$setValue(e,n,t),t+=n.strings.length-2):n._$setValue(e[t])),t++}}class ce{constructor(e,t,n,o){var r;this.type=Re,this._$committedValue=y,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=t,this._$parent=n,this.options=o,this.__isConnected=(r=o==null?void 0:o.isConnected)!==null&&r!==void 0?r:!0,this._textSanitizer=void 0}get _$isConnected(){var e,t;return(t=(e=this._$parent)===null||e===void 0?void 0:e._$isConnected)!==null&&t!==void 0?t:this.__isConnected}get parentNode(){let e=$(this._$startNode).parentNode;const t=this._$parent;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,t=this){var n;if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=J(this,e,t),se(e))e===y||e==null||e===""?(this._$committedValue!==y&&(f==null||f({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=y):e!==this._$committedValue&&e!==B&&this._commitText(e);else if(e._$litType$!==void 0)this._commitTemplateResult(e);else if(e.nodeType!==void 0){if(((n=this.options)===null||n===void 0?void 0:n.host)===e){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(e)}else Sn(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return $($(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){var t;if(this._$committedValue!==e){if(this._$clear(),z!==Ne){const n=(t=this._$startNode.parentNode)===null||t===void 0?void 0:t.nodeName;if(n==="STYLE"||n==="SCRIPT"){let o="Forbidden";throw n==="STYLE"?o="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":o="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(o)}}f==null||f({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==y&&se(this._$committedValue)){const t=$(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=rt(t,"data","property")),e=this._textSanitizer(e),f==null||f({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}else{const t=Y.createTextNode("");this._commitNode(t),this._textSanitizer===void 0&&(this._textSanitizer=rt(t,"data","property")),e=this._textSanitizer(e),f==null||f({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}this._$committedValue=e}_commitTemplateResult(e){var t;const{values:n,["_$litType$"]:o}=e,r=typeof o=="number"?this._$getTemplate(e):(o.el===void 0&&(o.el=ae.createElement(o.h,this.options)),o);if(((t=this._$committedValue)===null||t===void 0?void 0:t._$template)===r)f==null||f({kind:"template updating",template:r,instance:this._$committedValue,parts:this._$committedValue._parts,options:this.options,values:n}),this._$committedValue._update(n);else{const s=new On(r,this),l=s._clone(this.options);f==null||f({kind:"template instantiated",template:r,instance:s,parts:s._parts,options:this.options,fragment:l,values:n}),s._update(n),f==null||f({kind:"template instantiated and updated",template:r,instance:s,parts:s._parts,options:this.options,fragment:l,values:n}),this._commitNode(l),this._$committedValue=s}}_$getTemplate(e){let t=zt.get(e.strings);return t===void 0&&zt.set(e.strings,t=new ae(e)),t}_commitIterable(e){ui(this._$committedValue)||(this._$committedValue=[],this._$clear());const t=this._$committedValue;let n=0,o;for(const r of e)n===t.length?t.push(o=new ce(this._insert(re()),this._insert(re()),this,this.options)):o=t[n],o._$setValue(r),n++;n<t.length&&(this._$clear(o&&$(o._$endNode).nextSibling,n),t.length=n)}_$clear(e=$(this._$startNode).nextSibling,t){var n;for((n=this._$notifyConnectionChanged)===null||n===void 0||n.call(this,!1,!0,t);e&&e!==this._$endNode;){const o=$(e).nextSibling;$(e).remove(),e=o}}setConnected(e){var t;if(this._$parent===void 0)this.__isConnected=e,(t=this._$notifyConnectionChanged)===null||t===void 0||t.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class ke{constructor(e,t,n,o,r){this.type=ct,this._$committedValue=y,this._$disconnectableChildren=void 0,this.element=e,this.name=t,this._$parent=o,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$committedValue=new Array(n.length-1).fill(new String),this.strings=n):this._$committedValue=y,this._sanitizer=void 0}get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e,t=this,n,o){const r=this.strings;let s=!1;if(r===void 0)e=J(this,e,t,0),s=!se(e)||e!==this._$committedValue&&e!==B,s&&(this._$committedValue=e);else{const l=e;e=r[0];let a,d;for(a=0;a<r.length-1;a++)d=J(this,l[n+a],t,a),d===B&&(d=this._$committedValue[a]),s||(s=!se(d)||d!==this._$committedValue[a]),d===y?e=y:e!==y&&(e+=(d??"")+r[a+1]),this._$committedValue[a]=d}s&&!o&&this._commitValue(e)}_commitValue(e){e===y?$(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=z(this.element,this.name,"attribute")),e=this._sanitizer(e??""),f==null||f({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),$(this.element).setAttribute(this.name,e??""))}}class Pn extends ke{constructor(){super(...arguments),this.type=Nn}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=z(this.element,this.name,"property")),e=this._sanitizer(e),f==null||f({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===y?void 0:e}}const Dn=K?K.emptyScript:"";class Vn extends ke{constructor(){super(...arguments),this.type=kn}_commitValue(e){f==null||f({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==y),options:this.options}),e&&e!==y?$(this.element).setAttribute(this.name,Dn):$(this.element).removeAttribute(this.name)}}class Mn extends ke{constructor(e,t,n,o,r){if(super(e,t,n,o,r),this.type=An,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,t=this){var n;if(e=(n=J(this,e,t,0))!==null&&n!==void 0?n:y,e===B)return;const o=this._$committedValue,r=e===y&&o!==y||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==y&&(o===y||r);f==null||f({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:r,addListener:s,oldListener:o}),r&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var t,n;typeof this._$committedValue=="function"?this._$committedValue.call((n=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&n!==void 0?n:this.element,e):this._$committedValue.handleEvent(e)}}class Un{constructor(e,t,n){this.element=e,this.type=ht,this._$disconnectableChildren=void 0,this._$parent=t,this.options=n}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){f==null||f({kind:"commit to element binding",element:this.element,value:e,options:this.options}),J(this,e)}}const Ke=C.litHtmlPolyfillSupportDevMode;Ke==null||Ke(ae,ce);((He=C.litHtmlVersions)!==null&&He!==void 0?He:C.litHtmlVersions=[]).push("2.7.0");C.litHtmlVersions.length>1&&$e("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");const ye=(i,e,t)=>{var n,o;if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const r=vn++,s=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:e;let l=s._$litPart$;if(f==null||f({kind:"begin render",id:r,value:i,container:e,options:t,part:l}),l===void 0){const a=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;s._$litPart$=l=new ce(e.insertBefore(re(),a),a,void 0,t??{})}return l._$setValue(i),f==null||f({kind:"end render",id:r,value:i,container:e,options:t,part:l}),l};ye.setSanitizer=yn,ye.createSanitizer=rt,ye._testOnlyClearSanitizerFactoryDoNotCallOrElse=bn;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ye,Je,Xe;let ut;{const i=(Ye=globalThis.litIssuedWarnings)!==null&&Ye!==void 0?Ye:globalThis.litIssuedWarnings=new Set;ut=(e,t)=>{t+=` See https://lit.dev/msg/${e} for more information.`,i.has(t)||(console.warn(t),i.add(t))}}class H extends O{constructor(){super(...arguments),this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){var e,t;const n=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=n.firstChild),n}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.__childPart=ye(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this.__childPart)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.__childPart)===null||e===void 0||e.setConnected(!1)}render(){return B}}H.finalized=!0;H._$litElement$=!0;(Je=globalThis.litElementHydrateSupport)===null||Je===void 0||Je.call(globalThis,{LitElement:H});const Qe=globalThis.litElementPolyfillSupportDevMode;Qe==null||Qe({LitElement:H});H.finalize=function(){if(!O.finalize.call(this))return!1;const e=(t,n,o=!1)=>{if(t.hasOwnProperty(n)){const r=(typeof t=="function"?t:t.constructor).name;ut(o?"renamed-api":"removed-api",`\`${n}\` is implemented on class ${r}. It has been ${o?"renamed":"removed"} in this version of LitElement.`)}};return e(this,"render"),e(this,"getStyles",!0),e(this.prototype,"adoptStyles"),!0};((Xe=globalThis.litElementVersions)!==null&&Xe!==void 0?Xe:globalThis.litElementVersions=[]).push("3.3.0");globalThis.litElementVersions.length>1&&ut("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fn=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},Bn=(i,e,t)=>{e.constructor.createProperty(t,i)};function _(i){return(e,t)=>t!==void 0?Bn(i,e,t):Fn(i,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zn=({finisher:i,descriptor:e})=>(t,n)=>{var o;if(n!==void 0){const r=t.constructor;e!==void 0&&Object.defineProperty(t,n,e(n)),i==null||i(r,n)}else{const r=(o=t.originalKey)!==null&&o!==void 0?o:t.key,s=e!=null?{kind:"method",placement:"prototype",key:r,descriptor:e(t.key)}:{...t,key:r};return i!=null&&(s.finisher=function(l){i(l,r)}),s}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Hn(i,e){return zn({descriptor:t=>{const n={get(){var o,r;return(r=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(i))!==null&&r!==void 0?r:null},enumerable:!0,configurable:!0};if(e){const o=typeof t=="symbol"?Symbol():`__${t}`;n.get=function(){var r,s;return this[o]===void 0&&(this[o]=(s=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(i))!==null&&s!==void 0?s:null),this[o]}}return n}})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ze;const Wn=window;((Ze=Wn.HTMLSlotElement)===null||Ze===void 0?void 0:Ze.prototype.assignedElements)!=null;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jn={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Gn=i=>(...e)=>({_$litDirective$:i,values:e});class qn{constructor(e){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(e,t,n){this.__part=e,this._$parent=t,this.__attributeIndex=n}_$resolve(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Kn extends qn{constructor(e){var t;if(super(e),e.type!==jn.ATTRIBUTE||e.name!=="class"||((t=e.strings)===null||t===void 0?void 0:t.length)>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var n,o;if(this._previousClasses===void 0){this._previousClasses=new Set,e.strings!==void 0&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!(!((n=this._staticClasses)===null||n===void 0)&&n.has(s))&&this._previousClasses.add(s);return this.render(t)}const r=e.element.classList;this._previousClasses.forEach(s=>{s in t||(r.remove(s),this._previousClasses.delete(s))});for(const s in t){const l=!!t[s];l!==this._previousClasses.has(s)&&!(!((o=this._staticClasses)===null||o===void 0)&&o.has(s))&&(l?(r.add(s),this._previousClasses.add(s)):(r.remove(s),this._previousClasses.delete(s)))}return B}}const mi=Gn(Kn),et="css-loading-indicator";var N;(function(i){i.IDLE="",i.FIRST="first",i.SECOND="second",i.THIRD="third"})(N||(N={}));class w extends H{constructor(){super(),this.firstDelay=300,this.secondDelay=1500,this.thirdDelay=5e3,this.expandedDuration=2e3,this.onlineText="Online",this.offlineText="Connection lost",this.reconnectingText="Connection lost, trying to reconnect...",this.offline=!1,this.reconnecting=!1,this.expanded=!1,this.loading=!1,this.loadingBarState=N.IDLE,this.applyDefaultThemeState=!0,this.firstTimeout=0,this.secondTimeout=0,this.thirdTimeout=0,this.expandedTimeout=0,this.lastMessageState=b.CONNECTED,this.connectionStateListener=()=>{this.expanded=this.updateConnectionState(),this.expandedTimeout=this.timeoutFor(this.expandedTimeout,this.expanded,()=>{this.expanded=!1},this.expandedDuration)}}static create(){var e,t;const n=window;return!((e=n.Vaadin)===null||e===void 0)&&e.connectionIndicator||(n.Vaadin=n.Vaadin||{},n.Vaadin.connectionIndicator=document.createElement("vaadin-connection-indicator"),document.body.appendChild(n.Vaadin.connectionIndicator)),(t=n.Vaadin)===null||t===void 0?void 0:t.connectionIndicator}render(){return E`
...
`,g=class extends H{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[x`
    ...
    `}render(){return E` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,we(()=>import("./component-picker-1301ef3b.js"),[],import.meta.url)}}
        >
