...
- bookstore-starter-flow-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- bookstore-starter-flow-ui: main application module, development time
- bookstore-starter-flow-production: module that produces a production mode WAR for deployment
